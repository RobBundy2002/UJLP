                ...
                <div className="section-content">
                    ...
                    <div className="bio-content">
                        <p>
                            ...
                            <em> Principles of a Normative Constitution</em> (iUniverse, 2025, ISBN: 978-1-66327-1044), which presents
                            a theory of constitutional design grounded in political philosophy and comparative constitutional law, and
                            <em> 法律小谈</em> (<em>A Brief Talk About the Law</em>, Chinese Publishing Inc., 2023, ISBN: 978-1-64695-308),
                    ...
                    <div className="publications-list">
                        <div className="publication-item">
                            ...
                            <p className="publication-excerpt">
                                Presents a theory of constitutional design grounded in political philosophy and comparative constitutional law.
                            </p>
                        </div>
                        <div className="publication-item">
                            ...
                            <p className="publication-excerpt">
                                A concise and insightful introduction to legal thought written during the author’s final year of high school.
                            </p>
                        </div>
                    </div>
                </div>
