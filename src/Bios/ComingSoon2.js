                ...
                <div className="section-content">
                    <div className="author-content">
                        <div className="author-image">
                            <img src={comingSoonImg} alt="Coming Soon 2" />
                        </div>
                        <div className="author-info">
                            <h1>Coming Soon 2</h1>
                            <span className="author-role">Internal Writer</span>
                            <div className="author-details">
                                <p><strong>Current Year at UVA:</strong> Coming Here To You Shortly So Stay Tuned! </p>
